...
// Source: github.com/uwemakan/simplebank/db/sqlc (interfaces: Store)
...
func (m *MockStore) ListEntriesByAccountId(arg0 context.Context, arg1 db.ListEntriesByAccountIdParams) ([]db.Entry, error) {
	m.ctrl.T.Helper()
